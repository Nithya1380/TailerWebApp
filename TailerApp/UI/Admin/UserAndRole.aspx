...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container bootstrap snippet" ng-app="TailerApp" ng-controller="UserAndRoleController" >
                    ...
                    <div class="row">
                        <table class="table">
                            ...
                            <tbody ng-repeat="user in UserList">
                                <tr>
                                    <td><a href="#" ng-click="OnUserClick(user.UserID)">{{user.UserName}}</a></td>
                                    <td>{{user.LoginID}}</td>
                                    <td>{{user.RoleName}}</td>
                                    <td></td>
                                    <td></td>
        ...
        <div class="tab-pane" id="roleTab">
            <div class="row">
                <div class="col-lg-2 col-md-2 col-sm-2 pull-right" style="margin-bottom:5px">
                    <button class="btn btn-lg btn-success" type="button" ng-click="OnAddModifyRoleClick();"><i class="fas fa-plus-square"></i>&nbsp;Add New Role</button>
                </div>
            </div>
            <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
