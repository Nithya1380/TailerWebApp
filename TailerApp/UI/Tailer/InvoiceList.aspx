            ...
            <div class="col-lg-12">
                <div class="card_bg">
                    ...
                    <table class="table card_table">
                        <thead>
                            <tr>
                                <th><input type="checkbox" id="chk_InvoiceHead" data-ng-change="onCheckBoxClick()" data-ng-model="SelectAll" /></th>
                                <th>Invoice#</th>
                                <th>Name</th>
                                <th>Mobile</th>
                                <th>Date</th>
                        ...
                        <tbody data-ng-repeat=" Invoice in InvoiceFilteredList=(InvoiceList | filter:search:strict)">
                            <tr>
                                <td><input type="checkbox" id="chk_InvoiceLine" data-ng-model="Invoice.Selected" /> </td>
